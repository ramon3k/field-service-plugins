...
export default function PluginManagerPage() {
  ...
  const fetchPlugins = async () => {
    try {
      ...
      console.log('🔍 PluginManager: Fetching plugins with context:', { companyCode, userId })
      ...
      console.log('🔍 Available plugins:', availableData.plugins.length)

      // Fetch installed plugins with company context
      ...
      console.log('🔍 Installed plugins:', installedData.plugins.length, installedData.plugins)
